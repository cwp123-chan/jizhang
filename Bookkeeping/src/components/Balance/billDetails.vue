          ...
          <div v-for="money in lissMoney" :key="money.id">
              ...
              <div class="billDetails-body-list-img-img-div">
                <van-col span="8" v-for="pic in money.images" :key="pic.id">
                  <img
                    ...
                    @click="toImgshow(pic)"
                  />
                   <van-dialog v-model="imgshow" width="300px" @confirm = "deleteThisImg(picToImg)"  title="是否删除该凭证?" show-cancel-button>
                  <img :src="picToImg" />
                  </van-dialog>
            ...
            >
              ...
              <van-col span="8">
                ...
                <!-- <img
                  class="billDetails-body-list-img-img"
                  src="../../assets/u=634121950,3985757767&fm=214&gp=0.jpg"
                  alt
                />-->
                <div class="isnomore">
                  <span>暂无</span>
          ...
          <li class="billDetails-body-list billDetails-body-list-img">
            ...
            <div class="billDetails-body-list-img-img-div2">
              <div v-for="item in lissMoney" :key="item.index">
                ...
                <van-col span="8" v-for="zfpz in item.images"   @click="toImgshowdoub(zfpz)" :key="zfpz.id">
                  <img class="billDetails-body-list-img-img" :src="zfpz.thumbnail" alt />
                  <van-dialog v-model="imgshowdoub" width="300px" @confirm = "deleteThisImg(picToImg)"  title="是否删除该凭证?" show-cancel-button>
                  <img :src="picToImg" />
                  </van-dialog>
                </van-col>
...
export default {
  ...
  data() {
    return {
      // 其中  默认值为false或true 用来控制页面元素的显示和隐藏
      allIn: false,
      doubIn: false,
      totalTomoney: "",
      companyToname: "",
  ...
  methods: {
    ...
    toImgshow(img){
      this.imgshow = true
      this.imgshowdoub = false

      // console.log(img)
      this.picToImg = img.thumbnail
    },
    toImgshowdoub(img){
      // this.imgshowdoub = true
      this.imgshow = false
      this.picToImg = img.thumbnail
...
.billDetails .backitem {
  position: absolute;
  z-index: 999;
}
.billDetails .van-col--8 {
  width: 31.333333%;
  overflow: hidden;
